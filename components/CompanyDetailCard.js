        ...
        <Box>
            ...
            <Container>
                <ShortInfo>
                    ...
                    <QuickInfoContainer>
                        <CompanyQuickPrice
                            discountedPrice={companyDetails.expected_annually_discounted_bill_amount}
                            monthlyPrice={companyDetails.expected_monthly_discounted_bill_amount}
                        />
                    </QuickInfoContainer>
                </ShortInfo>
                <Description dangerouslySetInnerHTML={{ __html: companyDetails.dmo_content.Ausgrid }} />
            </Container>
